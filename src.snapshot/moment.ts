...
export class Moment {
  ...
  year(y?: any): number | Moment {
    if (y !== undefined) {
      ...
      const date = this._gdt("Date");
      this._sdt("FullYear", num);
      if (this._gdt("Date") !== date) {
        this._sdt("Date", 0);
      }
      this._updateOffset(true);
      return this;
    }
    return this._isValid ? this._gdt("FullYear") : NaN;
  }
  ...
  month(m?: any): number | Moment {
    ...
    return this._isValid ? this._gdt("Month") : NaN;
  }
  ...
  date(d?: any): number | Moment {
    ...
    return this._isValid ? this._gdt("Date") : NaN;
  }
  ...
  day(d?: any): number | Moment {
    if (d !== undefined) {
      ...
      const currentDay = this._gdt("Day");
    ...
    return this._isValid ? this._gdt("Day") : NaN;
  }

  weekday(d?: number): number | Moment {
    if (d !== undefined) {
      const current = this._gdt("Day");
  ...
  dayOfYear(d?: number): number | Moment {
    ...
    if (this._isUTC) {
      const startOfYear = Date.UTC(this._gdt("FullYear"), 0, 0);
      const diff = this._d.getTime() - startOfYear;
      return Math.floor(diff / 86400000);
    }
    const startOfYear = new Date(this._gdt("FullYear"), 0, 0);
  ...
  hour(h?: any): number | Moment {
    ...
    return this._isValid ? this._gdt("Hours") : NaN;
  }
  ...
  minute(m?: any): number | Moment {
    if (m !== undefined) {
      ...
      const num = Number(m);
      if (isNaN(num)) return this;
      this._sdt("Minutes", num);
      this._updateOffset(true);
      return this;
    }
    return this._isValid ? this._gdt("Minutes") : NaN;
  }
  ...
  second(s?: any): number | Moment {
    if (s !== undefined) {
      ...
      const num = Number(s);
      if (isNaN(num)) return this;
      this._sdt("Seconds", num);
      this._updateOffset(true);
      return this;
    }
    return this._isValid ? this._gdt("Seconds") : NaN;
  }
  ...
  millisecond(ms?: any): number | Moment {
    if (ms !== undefined) {
      ...
      const num = Number(ms);
      if (isNaN(num)) return this;
      this._sdt("Milliseconds", num);
      this._updateOffset(true);
      return this;
    }
    return this._isValid ? this._gdt("Milliseconds") : NaN;
  }
