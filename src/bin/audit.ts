...
const NEVER_MOMENT = new Set([
  ...
  "toHaveLength", "toHaveProperty", "toBeDefined", "toBeUndefined",
  "toBeNull", "toBeNaN", "toBeTruthy", "toBeFalsy",
  "toMatch", "toMatchObject", "toThrow", "toThrowError",
  "toBeGreaterThan", "toBeGreaterThanOrEqual", "toBeLessThan", "toBeLessThanOrEqual",
  "toBeCloseTo", "resolves", "rejects", "not",
  "forEach", "map", "filter", "reduce", "find", "findIndex",
  "some", "every", "includes", "indexOf", "push", "pop", "shift",
  "unshift", "splice", "slice", "concat", "join", "sort", "reverse",
  "split", "trim", "replace", "match", "search", "charAt",
  "charCodeAt", "padStart", "padEnd", "startsWith", "endsWith",
...
const KNOWN_MOMENT_STATICS = [
  "utc", "parseZone", "unix", "invalid", "locale", "localeData",
  "lang", "langData", "defineLocale", "updateLocale", "locales",
  "months", "monthsShort", "weekdays", "weekdaysShort", "weekdaysMin",
  "normalizeUnits", "min", "max", "now", "duration", "relativeTimeRounding",
  "relativeTimeThreshold", "fn", "suppressDeprecationWarnings",
  "deprecationHandler", "version", "defaultFormat", "defaultFormatUtc",
  "createFromInputFallback",
  "isDuration", "isMoment", "isDate",
  "normalizeUnits",
];

const KNOWN_MOMENT_INSTANCE = [
  "format", "add", "subtract", "diff", "clone", "isBefore", "isAfter",
  "isSame", "isSameOrBefore", "isSameOrAfter", "isBetween", "isValid",
  "isLeapYear", "isDST", "isUTC", "isLocal", "isUtcOffset",
  "year", "month", "date", "day", "hour", "minute", "second", "millisecond",
  "weekday", "isoWeekday", "dayOfYear", "week", "isoWeek",
  "weekYear", "isoWeekYear", "weeksInYear", "isoWeeksInYear",
  "quarter", "daysInMonth", "startOf", "endOf",
  "valueOf", "unix", "toISOString", "toJSON", "toDate",
  "toArray", "toObject", "toString", "locale", "localeData",
  "get", "set", "max", "min", "utc", "local", "utcOffset",
  "parseZone", "zone", "lang", "from", "to", "calendar",
  "creationData", "parsingFlags", "inspect",
  // Duration methods
  "as", "asMilliseconds", "asSeconds", "asMinutes", "asHours",
  "asDays", "asWeeks", "asMonths", "asQuarters", "asYears",
  "humanize", "toISOString", "toJSON", "toIsoString",
  "years", "months", "weeks", "days", "hours", "minutes", "seconds",
  "milliseconds", "get", "_milliseconds",
  // Locale methods
  "firstDayOfWeek", "firstDayOfYear",
  // Display methods
  "from", "fromNow", "to", "toNow",
  // Zone methods
  "zoneAbbr", "zoneName", "hasAlignedHourOffset",
  // Others
  "invalidAt", "isDuration", "isMoment", "isDate",
  "isoWeeks", "weeksInWeekYear", "isoWeeksInISOWeekYear",
];
