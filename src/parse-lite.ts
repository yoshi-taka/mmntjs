...
function parseRFC2822(str: string): ParsedData | null {
  ...
  if (match[1]) {out._weekdayName = String(WEEKDAY_NAMES_MAP[match[1].slice(0, 3).toLowerCase()]);}
  return out;
}
...
export function parseObject(obj: Record<string, unknown>): Record<string, unknown> {
  ...
  if (hasOwnProp(obj, "minute") || hasOwnProp(obj, "minutes") || hasOwnProp(obj, "m")) {
    const v = obj.minute !== undefined ? obj.minute : obj.minutes !== undefined ? obj.minutes : obj.m;
    if (v != null) {result.minute = Number(v);}
  }
  if (hasOwnProp(obj, "second") || hasOwnProp(obj, "seconds") || hasOwnProp(obj, "s")) {
    const v = obj.second !== undefined ? obj.second : obj.seconds !== undefined ? obj.seconds : obj.s;
    if (v != null) {result.second = Number(v);}
  }
  if (hasOwnProp(obj, "millisecond") || hasOwnProp(obj, "milliseconds") || hasOwnProp(obj, "ms")) {
    const v = obj.millisecond !== undefined ? obj.millisecond : obj.milliseconds !== undefined ? obj.milliseconds : obj.ms;
