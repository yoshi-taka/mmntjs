...
const CASES: BenchCase[] = [
  ...
  },
  {
    ...
    run: () => [() => moment([2024, 0, 15, 10, 30, 45, 123]), () => mmntjs([2024, 0, 15, 10, 30, 45, 123])],
  },
  {
  ...
  {
    name: "moment(Date)",
    run: () => { const d = new Date(); return [() => moment(d), () => mmntjs(d)]; },
  },
  {
  ...
  },
  {
    ...
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.format("dddd, MMMM Do YYYY, h:mm:ss a"), () => b.format("dddd, MMMM Do YYYY, h:mm:ss a")]; },
  },
  {
    name: "format('LL')",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.format("LL"), () => b.format("LL")]; },
  },
  {
  ...
  },
  {
    ...
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => { a.year(2020); a.month(0); a.date(1); }, () => { b.year(2020); b.month(0); b.date(1); }]; },
  },
  {
    name: "add(1,'day')",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.add(1, "day"), () => b.add(1, "day")]; },
  },
  {
    name: "add(1,'month')",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.add(1, "month"), () => b.add(1, "month")]; },
  },
  {
    name: "subtract(7,'days').add(1,'month')",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.subtract(7, "days").add(1, "month"), () => b.subtract(7, "days").add(1, "month")]; },
  },
  {
  ...
  },
  {
    ...
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => { a.startOf("month"); a.endOf("month"); }, () => { b.startOf("month"); b.endOf("month"); }]; },
  },
  {
    name: "startOf('week').startOf('year')",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => { a.startOf("week"); a.startOf("year"); }, () => { b.startOf("week"); b.startOf("year"); }]; },
  },
  {
    name: "clone",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.clone(), () => b.clone()]; },
  },
  {
  ...
  {
    name: "valueOf / unix",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => { a.valueOf(); a.unix(); }, () => { b.valueOf(); b.unix(); }]; },
  },
  {
    name: "daysInMonth / isLeapYear",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => { a.daysInMonth(); a.isLeapYear(); }, () => { b.daysInMonth(); b.isLeapYear(); }]; },
  },
  {
    name: "startOf('year')",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.startOf("year"), () => b.startOf("year")]; },
  },
  {
    name: "endOf('year')",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.endOf("year"), () => b.endOf("year")]; },
  },
  {
    name: "moment('ISO string') with format",
    run: () => [() => moment("2024-01-15T10:30:45.123Z", "YYYY-MM-DDTHH:mm:ss.SSSZ"), () => mmntjs("2024-01-15T10:30:45.123Z", "YYYY-MM-DDTHH:mm:ss.SSSZ")],
  },
  {
  ...
  },
  {
    ...
    run: () => { const a = moment("2024-06-15 10:30:45"), b = mmntjs("2024-06-15 10:30:45"); return [() => a.format("HH:mm:ss"), () => b.format("HH:mm:ss")]; },
  },
  {
    name: "add(1,'year')",
    run: () => { const a = moment("2024-06-15"), b = mmntjs("2024-06-15"); return [() => a.add(1, "year"), () => b.add(1, "year")]; },
  },
];
