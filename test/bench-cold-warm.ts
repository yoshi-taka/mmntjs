...
const cases = [
  {
    name: "LL (fr)",
    setupCold: () => {
      _localeCache.delete("fr");
      setLocale("en");
    },
    setupWarm: () => {
      mmntjs(date).locale("fr");
      setLocale("en");
    },
    m2: () => {
      mmntjs(date).locale("fr").format("LL");
    },
  ...
  },
  {
    ...
    m2: () => {
      mmntjs(date).locale("fr").format("LT");
    },
  ...
  },
  {
    ...
    m2: () => {
      mmntjs(date).locale("fr").format("LLL");
    },
...
console.log(
  "Operation                mmntjs cold   mmntjs warm   date-fns      cold vs df  warm vs df",
);
