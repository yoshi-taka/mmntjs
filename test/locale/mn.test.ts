...
test("parse", function (assert) {
  ...
  assert.equal(
    moment("1989 он, Арван хоёрдугаар сар 11", ["YYYY [он], MMMM DD"]).format("YYYY-MM-DD"),
    "1989-12-11",
  );
  assert.equal(
    moment("1989 оны 11 сарын 2", ["YYYY [оны] MMMM[ын] DD"]).format("YYYY-MM-D"),
    "1989-11-2",
  );
  assert.equal(
    moment("1989 оны 5 сарын 11 өдөр", ["YYYY [оны] MMMM[ын] Do"]).format("YYYY-MM-DD"),
    "1989-05-11",
  );
  assert.equal(
    moment("1989 оны 5 сарын 11 өдөр 11:25 ҮӨ", ["YYYY [оны] MMM[ын] Do h:mm a"]).format(
      "YYYY-MM-DD h:mm a",
    ),
    "1989-05-11 11:25 ҮӨ",
  );
