...
import { ar_maLocale } from "../../src/locale/ar-ma";
import { defineLocale } from "../../src/locale";

defineLocale("ar-ma", ar_maLocale);
...
test("format week", function (assert) {
  let expected =
      "الأحد احد ح_الإثنين اثنين ن_الثلاثاء ثلاثاء ث_الأربعاء اربعاء ر_الخميس خميس خ_الجمعة جمعة ج_السبت سبت س".split(
        "_",
      ),
    i;
  for (i = 0; i < expected.length; i++) {
