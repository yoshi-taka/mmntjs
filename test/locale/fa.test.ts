...
import { faLocale } from "../../src/locale/fa";
import { defineLocale } from "../../src/locale";

defineLocale("fa", faLocale);

localeModule("fa");

test("parse", function (assert) {
  let tests = "ژانویه_فوریه_مارس_آوریل_مه_ژوئن_ژوئیه_اوت_سپتامبر_اکتبر_نوامبر_دسامبر".split("_"),
    i: number;
