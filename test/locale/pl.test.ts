...
import { plLocale } from "../../src/locale/pl";
...
test("parse", function (assert) {
  ...
  for (i = 0; i < 12; i++) {
    ...
    equalTestStrict(a[1], "MMMM", i);
    // Fails for all months
    // equalTestStrict(a[0].toLocaleLowerCase(), 'MMM', i);
    // Fails for all months
    // equalTestStrict(a[0].toLocaleUpperCase(), 'MMM', i);
    equalTestStrict(a[0].toLocaleLowerCase(), "MMMM", i);
    equalTestStrict(a[0].toLocaleUpperCase(), "MMMM", i);
    equalTestStrict(a[1].toLocaleLowerCase(), "MMMM", i);
    equalTestStrict(a[1].toLocaleUpperCase(), "MMMM", i);
  }
});
