...
import { ar_dzLocale } from "../../src/locale/ar-dz";
import { defineLocale } from "../../src/locale";

defineLocale("ar-dz", ar_dzLocale);
...
test("format", function (assert) {
  let a = [
      ["dddd, MMMM Do YYYY, h:mm:ss a", "الأحد، فيفري 14 2010، 3:25:50 م"],
      ["ddd, hA", "أحد، 3م"],
...
test("weeks year starting sunday formatted", function (assert) {
  assert.equal(moment([2011, 1, 4]).format("w ww wo"), "5 05 5", "Feb 4 2011 should be week 5");
