...
import { hiLocale } from "../../src/locale/hi";
...
test("parse", function (assert) {
  ...
  for (i = 0; i < 12; i++) {
    const a = testsStandalone[i].split(" ");
    equalTest(a[0], "MMM", i);
    equalTest(a[1], "MMM", i);
    equalTest(a[0], "MMMM", i);
    equalTest(a[1], "MMMM", i);
...
test("format month case", function (assert) {
  let months = {
      nominative: "जनवरी_फरवरी_मार्च_अप्रैल_मई_जून_जुलाई_अगस्त_सितंबर_अक्टूबर_नवंबर_दिसंबर".split("_"),
      accusative: "जनवरी_फ़रवरी_मार्च_अप्रैल_मई_जून_जुलाई_अगस्त_सितम्बर_अक्टूबर_नवम्बर_दिसम्बर".split("_"),
    },
    i;
  for (i = 0; i < 12; i++) {
    assert.equal(
