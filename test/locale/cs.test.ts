...
import { csLocale } from "../../src/locale/cs";
...
test('parse', function (assert) {
    let tests =
        ...
        i;
    function equalTest(input: any, mmm: any, monthIndex: any) {
        assert.equal(
    ...
    for (i = 0; i < 12; i++) {
        ...
        equalTestStrict(a[2].toLocaleLowerCase(), 'MMMM', i);
        equalTestStrict(a[2].toLocaleUpperCase(), 'MMMM', i);
    }
});
