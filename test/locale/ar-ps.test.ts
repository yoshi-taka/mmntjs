...
import { ar_psLocale } from "../../src/locale/ar-ps";
import { defineLocale } from "../../src/locale";

defineLocale("ar-ps", ar_psLocale);
...
test('format', function (assert) {
    var a = [
            ['dddd, MMMM Do YYYY, h:mm:ss a', 'الأحد، شباط ١٤ ٢٠١٠، ٣:٢٥:٥٠ م'],
            ['ddd, hA', 'أحد، ٣م'],
            ['M Mo MM MMMM MMM', '٢ ٢ ٠٢ شباط شباط'],
            ['YYYY YY', '٢٠١٠ ١٠'],
            ['D Do DD', '١٤ ١٤ ١٤'],
