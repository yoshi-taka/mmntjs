...
import { loLocale } from "../../src/locale/lo";
import { defineLocale } from "../../src/locale";

defineLocale("lo", loLocale);
...
test("format week", function (assert) {
  let expected = "ອາທິດ ທິດ ທ_ຈັນ ຈັນ ຈ_ອັງຄານ ອັງຄານ ອຄ_ພຸດ ພຸດ ພ_ພະຫັດ ພະຫັດ ພຫ_ສຸກ ສຸກ ສກ_ເສົາ ເສົາ ສ".split(
      "_",
    ),
    i;
  for (i = 0; i < expected.length; i++) {
