...
describe("normalizeUnits", () => {
  test("recognizes all unit aliases", () => {
    const cases: [string, string][] = [
      ["year", "year"], ["years", "year"], ["y", "year"], ["Y", "year"],
      ...
      ["dayOfYear", "dayOfYear"], ["dayOfYears", "dayOfYear"], ["DDD", "dayOfYear"],
      ["weekYear", "weekYear"], ["weekYears", "weekYear"], ["gg", "weekYear"],
      ["isoWeekYear", "isoWeekYear"], ["isoWeekYears", "isoWeekYear"], ["GG", "isoWeekYear"],
    ];
