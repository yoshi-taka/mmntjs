...
(0, yargs_1.default)(process.argv.slice(2))
    ...
    .command("$0 <fuzzTarget> [corpus..]", "Coverage-guided, in-process fuzzer for the Node.js platform. \n\n" +
    ...
    yargs
        ...
        defaultDescription: options_1.defaultCLIOptions.fuzzEntryPoint,
        ...
        array: true,
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.includes)}`,
        ...
        array: true,
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.excludes)}`,
        ...
        .option("idSyncFile", {
        alias: ["id_sync_file"],
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.idSyncFile)}`,
        ...
        array: true,
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.customHooks)}`,
        ...
        array: true,
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.expectedErrors)}`,
        ...
        array: true,
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.disableBugDetectors)}`,
        ...
        .option("mode", {
        alias: "m",
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.mode)}`,
        ...
        .option("dryRun", {
        alias: ["dry_run", "d"],
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.dryRun)}`,
        describe: "Perform a run with the fuzzing instrumentation disabled.",
        group: "Fuzzer:",
        type: "boolean",
    })
        .option("timeout", {
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.timeout)}`,
        describe: "Timeout in milliseconds for each fuzz test execution.",
        group: "Fuzzer:",
        type: "number",
    })
        .option("sync", {
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.sync)}`,
        ...
        .option("verbose", {
        alias: "v",
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.verbose)}`,
        ...
        .option("coverage", {
        alias: "cov",
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.coverage)}`,
        ...
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.coverageDirectory)}`,
        ...
        array: true,
        defaultDescription: `${JSON.stringify(options_1.defaultCLIOptions.coverageReporters)}`,
...
async (args) => {
    const options = new options_1.OptionsManager(options_1.OptionSource.DefaultCLIOptions).merge((0, utils_1.prepareArgs)(args), options_1.OptionSource.CommandLineArguments);
    return (0, core_1.startFuzzing)(options).then(({ returnCode, error }) => {
