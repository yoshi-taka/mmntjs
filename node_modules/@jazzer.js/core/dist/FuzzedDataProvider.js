...
class FuzzedDataProvider {
    ...
    consumeString(maxLength) {
        ...
        const result = this.data.toString("utf-8", this.dataPtr, this.dataPtr + arrayLength);
        this.dataPtr += arrayLength;
        this._remainingBytes -= arrayLength;
        return result;
    }
...
FuzzedDataProvider.min_float = -3.4028235e38;
FuzzedDataProvider.max_float = 3.4028235e38;
FuzzedDataProvider.min_double = -Number.MAX_VALUE;
FuzzedDataProvider.max_double = Number.MAX_VALUE;
