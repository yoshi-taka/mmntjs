...
export declare class HookManager {
     ...
     */
    finalizeHooks(vmContext: vm.Context | typeof globalThis): Promise<void>;
...
export declare function getFunction(module: object, propertyAccessors: string[]): unknown;
export declare function setFunction(module: object, propertyAccessors: string[], newFunction: unknown): void;
/**
