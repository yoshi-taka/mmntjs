...
exports.esmCodeCoverage = esmCodeCoverage;
/**
...
const coverageVisitor_1 = require("./coverageVisitor");
 ...
 */
function neverZeroIncrement(id) {
    const element = () => core_1.types.memberExpression(core_1.types.identifier(COUNTER_ARRAY), core_1.types.numericLiteral(id), true);
    return core_1.types.assignmentExpression("=", element(), core_1.types.binaryExpression("+", core_1.types.binaryExpression("%", element(), core_1.types.numericLiteral(255)), core_1.types.numericLiteral(1)));
}
/**
 ...
 */
function esmCodeCoverage() {
    let count = 0;
    return {
        plugin: () => ({
            visitor: (0, coverageVisitor_1.makeCoverageVisitor)(() => neverZeroIncrement(count++)),
        }),
        edgeCount: () => count,
    };
}
//# sourceMappingURL=esmCodeCoverage.js.map